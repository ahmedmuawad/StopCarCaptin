 ...
 */
public class Reviewtodayadapter extends RecyclerView.Adapter<Reviewtodayadapter.MyViewHolder> {
    Context context;
    private List<History.ResultBean.TodayBean.TripsBean> horizontalList;
    ...
    public Reviewtodayadapter(List<History.ResultBean.TodayBean.TripsBean> horizontalList) {
